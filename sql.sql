...
-- ----------------------------
BEGIN;
INSERT INTO `account` (`accountid`, `balance`) VALUES (1, 8392.8), (2, 28000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `trade` (`tradeid`, `userid`, `tradetime`) VALUES (43, 1, '2022-06-30 14:26:06'), (44, 1, '2022-06-30 14:28:43'), (45, 1, '2022-06-30 14:49:56');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tradeitem` (`itemid`, `bookid`, `quantity`, `tradeid`) VALUES (77, 1, 1, 43), (78, 2, 1, 43), (79, 1, 1, 44), (80, 2, 1, 44), (81, 1, 1, 45);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `userinfo` (`userid`, `username`, `password`, `accountid`) VALUES (1, 'Tom', '666', 1), (2, 'Jack', '12345', 1);
COMMIT;
