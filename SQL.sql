...
-- ----------------------------
BEGIN;
INSERT INTO `account` (`accountid`, `balance`) VALUES (1, 6083.1), (2, 20008);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `trade` (`tradeid`, `userid`, `tradetime`) VALUES (1, 1, '2022-07-05 17:09:56'), (2, 1, '2022-07-05 17:12:06'), (3, 2, '2022-07-05 20:23:43'), (4, 2, '2022-07-05 21:33:07'), (5, 1, '2022-07-05 22:30:56'), (6, 1, '2022-07-05 23:53:35'), (7, 1, '2022-07-06 10:00:39');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tradeitem` (`itemid`, `tradeid`, `bookid`, `order_serial_number`, `quantity`, `delivery_state`) VALUES (1, 1, 1, '123456789111315', 1, '已下单'), (2, 1, 2, '123456789111316', 1, '已下单'), (3, 1, 3, '123456789111317', 1, '已下单'), (4, 2, 5, '123456789111318', 5, '已下单'), (5, 3, 18, '123456789111319', 1, '已下单'), (6, 3, 12, '123456789111320', 1, '已下单'), (7, 3, 15, '123456789111321', 1, '已下单'), (8, 4, 1, '123456789111322', 1, '已下单'), (9, 4, 13, '123456789111323', 1, '已下单'), (10, 5, 8, '123456789111324', 1, '已发货'), (11, 6, 23, '202207052318644', 1, '已下单'), (12, 6, 25, '202207052313696', 1, '已下单'), (13, 7, 16, '202207061058884', 7, '已下单'), (14, 7, 19, '202207061042996', 2, '已下单'), (15, 7, 21, '202207061059543', 1, '已下单'), (16, 7, 23, '202207061022159', 1, '已下单'), (17, 7, 12, '202207061034215', 3, '已下单'), (18, 7, 13, '202207061042178', 1, '已下单'), (19, 7, 15, '202207061041562', 5, '已下单');
COMMIT;
